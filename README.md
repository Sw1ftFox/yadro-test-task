📋 User Manager – Тестовое задание (Angular)

> Простое Angular-приложение для управления пользователями.
> Реализованы: список пользователей (пагинация, фильтрация), детальная информация пользователей, форма создания/редактирования.
